...
## 🔧 Performance Calculator Implementation (Current - Jan 24, 2026)

- [ ] Make performance parameters editable on Performance Parameters page
- [ ] Add source/notes field for each parameter (extracted/assumed/manual)
- [ ] Track parameter source: "Extracted from IM", "Assumed - industry standard", "Manual input"
- [ ] Implement PVWatts-style performance calculator
- [ ] Add "Run Validation" button to trigger calculation
- [ ] Display calculated vs claimed generation with variance
- [ ] Flag variances >10% as potential red flags
- [ ] Store validation results in performance_validations table
- [ ] Show calculation assumptions and confidence level
- [ ] Handle missing parameters with industry-standard assumptions
